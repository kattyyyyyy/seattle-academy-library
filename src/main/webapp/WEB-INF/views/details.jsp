    ...
    <main>
        ...
        <div class="content_body detail_book_content">
            <div class="content_left">
                ...
                <div>${bookDetailsInfo.rentStatus}</div>
                <c:if test="${!empty rentErrorMessage}">
                    <div class="error">${rentErrorMessage}</div>
                </c:if>
            </div>
            <div class="content_right">
                ...
                <div>
                    <span>説明文</span>
                    <p>${bookDetailsInfo.text}</p>
                </div>
            </div>
        </div>
        <div class="edtDelBookBtn_box">
            <form method="post" action="rentBook">
                <input type="hidden" value="${bookDetailsInfo.title}" name="title">
